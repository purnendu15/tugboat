...
class FormationPlugin(BaseDataSourcePlugin):
    ...
    def _generate_token(self):
        ...
        self.client_config = swagger_client.Configuration()
    ...
    def _get_formation_client(self):
        ...
        self.formation_api_client = swagger_client.ApiClient(
            self.client_config)
    ...
    def _get_racks(self, zone, rack_type='compute'):
        zone_id = self._get_zone_id_by_name(zone)
        rack_api = swagger_client.RacksApi(self.formation_api_client)
